...
const UploadPage = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center  pl-2 pr-2" style={{ backgroundColor: currentTheme?.background }}>
      ...
      <section className=" h-auto max-w-120 w-full rounded-xl p-2 pt-5 flex flex-col gap-2 items-center mt-10"
      ...
      >
        ...
        <div className="w-full flex gap-1">
          <input value={resourceData.title}
            ...
            type="text" name="title" className="h-10 w-full outline-none pl-2 pr-1  text-xs mt-3" placeholder="enter title"
            style={{ backgroundColor: currentTheme.background }}>
          </input>

          <select
            className="h-10 w-full outline-none pl-2 pr-1  text-xs mt-3" name="linkType"
            style={{ backgroundColor: currentTheme.background }}
